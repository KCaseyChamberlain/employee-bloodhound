...
roleQuestions = [
    ...
    },
    {
        type: 'input',
        name: 'roleSalery',
        message: "What is the role's salery? (Required)",
        validate: roleSalery => {
            if (roleSalery) {
                return true;
            } else {
                console.log("Please enter the role's salery!");
                return false;
            }
        }
    },
    {
        ...
        validate: roleDepID => {
            if (roleDepID) {
                ...
                console.log("Please enter the role's department ID1!");
                return false;
            }
        }
    }
...
module.exports = { starterQuestion, employeeQuestions, roleQuestions };